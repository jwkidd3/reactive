package com.kiddcorp.reactive.app.config;
...
import com.kiddcorp.reactive.app.handler.ObservableReturnValueHandler;

@Configuration
@EnableWebMvc
@ComponentScan(basePackages={"com.kiddcorp.reactive.app.controller.*"})
